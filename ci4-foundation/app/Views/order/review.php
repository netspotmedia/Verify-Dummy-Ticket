...
<h2>Review Order</h2>
<p class="text-muted">Confirm your details and continue to checkout.</p>
...
<div class="card card-body mb-3">
  ...
  <p class="mb-1"><strong>Route:</strong> <?= esc($form['from'] ?? 'N/A') ?> → <?= esc($form['to'] ?? 'N/A') ?></p>
...
<form method="post" action="/order/checkout" class="d-flex flex-wrap gap-2">
  <input type="hidden" name="order_number" value="VDT-<?= date('YmdHis') ?>">
