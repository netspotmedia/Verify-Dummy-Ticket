  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between pt-4">
        ...
        <Button onClick={nextStep} disabled={!deliverySpeed} className="gap-2 rounded-full bg-gradient-to-r from-[#c8143d] to-[#d94a6d] hover:from-[#d94a6d] hover:to-[#c8143d] text-white shadow-lg shadow-red-200/50 px-6">
          Continue to Payment
